...
%%
%% The "title" command
\title{Title in the title in the main language of the paper}
\title[mode=trans]{Este es el título traducido, en este caso al español}
%%
...
%% article.
\begin{abstract}
This is the placeholder of the abstract.
\end{abstract}
